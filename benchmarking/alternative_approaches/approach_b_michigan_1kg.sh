#!/bin/bash
################################################################################
# approach_b_michigan_1kg.sh
#
# APPROACH B: Minimal QC-Before + Michigan 1000G (Southam 2011 Recommendation)
#
...
INPUT_PLINK=""
OUTPUT_DIR="./results/approach_b_michigan_1kg"
MICHIGAN_TOKEN=""
MICHIGAN_PASSWORD=""
THREADS=4
...
APPROACH B: Minimal QC-before-imputation (Southam 2011) + Michigan 1000G.
...
log "=============================================="
log "APPROACH B: Minimal QC + Michigan 1000G (Southam 2011)"
log "=============================================="
...
log ""
log "=== STEP 3: Submit to Michigan Server (1000G) ==="
...
if [[ -f "../qc_after/imputed_r2filt.bed" ]]; then
    run_post_imputation_qc "../qc_after/imputed_r2filt" "approach_b_michigan_1kg" ${THREADS} \
        ${MAF_THRESHOLD} ${HWE_PVALUE} 0.02 0.02

    log "  Final: $(count_variants_samples approach_b_michigan_1kg)"
fi
...
log ""
log "=============================================="
log "APPROACH B (Michigan 1000G) Complete!"
log "=============================================="
